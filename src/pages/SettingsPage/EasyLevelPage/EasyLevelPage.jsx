...
function EasyLevelPage () {
  ...
  function handleCellClick(row, col) {
    ...
    if (newGrid[row][col].hasMine) {
      ...
      setCountFlag(prevCountFlag => Math.min(prevCountFlag + flaggedCellsOpened, 10));
  ...
  return (
    <main className="easyLevelPageContainer">
      <div className="easyGridContainer">
        <table>
          <tbody>
